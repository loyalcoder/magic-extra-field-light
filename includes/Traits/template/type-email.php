...
/**
 * Template for email field type
 *
 * This template handles the rendering of an email input field with optional label.
 ...
 *     @type string $type        Field type (email)
...
<div class="<?php echo esc_attr(join(' ', $parent_class)); ?>">
    ...
    <div class="magic-extra-field-field-input">
        <input type="email" <?php echo wp_kses_data($this->attr_generate($args)); ?> />
    </div>
</div>