...
class Input_Number extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $default_content_controls = [
            ...
            'step_value' => [
                'label' => esc_html__('Step Value', 'magic-extra-field-light'),
    ...
    protected function render() {
        ...
        // Add min, max, and step if defined
        if (!empty($settings['min_value'])) {
            $filed_args['min'] = $settings['min_value'];  // Minimum value
        }
        if (!empty($settings['max_value'])) {
            $filed_args['max'] = $settings['max_value'];  // Maximum value
        }
        if (!empty($settings['step_value'])) {
            $filed_args['step'] = $settings['step_value'];  // Step value
        }
        echo wp_kses(
